<?php
    ...
    class SalesLog extends Application
	{
		var $fields;
		var $printHtml = false;
		...
		public function renderHTML()
		{
			...
			if($this->printHtml == false)
			{
				...
				//$file = fopen("/home/gbritton/test/desklogquery.sql", a);
				//fwrite($file, $sql);
				...
				if($this->printing == false)
				{
							$html .= 	'<table width=100% border=0 cellmargin=0 cellpadding=0 cellspacing=0 class="desk-log-table">
									...
									<tr>
										<td class="desk-log-summary-label">Front:</td><td>'.$this->formatNumber($front, "$").'</td><td class="desk-log-summary-label">Toyoguard:</td><td>'.$this->formatNumber($toyoguard, "$").'</td><td class="desk-log-summary-label">2%:</td><td>'.$this->formatNumber($onepercent, "$").'</td><td class="desk-log-summary-label">Back:</td><td>'.$this->formatNumber($back, "$").'</td><td class="desk-log-summary-label">MTD AVG:</td><td>'.$this->formatNumber($mtdavg, "$").'</td>
									</tr>
									<tr>
					...
					$html .= '<form method=post action="/gbSuite/apps/process_application.php?app=sales_log&action=add&uid='.$this->user->getUID().'&redirect=sales_log" id="desk-log">';
										...
										if($key == 'nu')
										{
											...
											if($key == 'status')
											{
												...
												if($key == 'source')
												{
													...
													{
														if($key != "dl_date")
															$html .= "<div><input class='desk-log-input' type=input id='desk_log_". $key ."'  name='desk_log_". $key ."' />";
														else
								...
								<div class="sbox-content-iframe" id="sbox-content">
									<div id="back-sbox-content" style="display:none;">
										<table class="sand-box-table" cellspacing=0 border=0>
											<tr><td><label for="desk-log-reserve">Reserve:</label></td><td><input class="sand-box-input" id="desk-log-reserve" name="desk_log_reserve" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" type="text" value="0" /></td>	    						
											<td><label for="desk-log-vsi">VSI:</label></td><td><input class="sand-box-input" id="desk-log-vsi" name="desk_log_vsi" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
											<td><label for="desk-log-cc">CC:</label></td><td><input class="sand-box-input" id="desk-log-cc" name="desk_log_cc" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
											<td><label for="desk-log-gap">GAP:</label></td><td><input class="sand-box-input" id="desk-log-gap" name="desk_log_gap" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
											<td><label for="desk-log-cl">CL:</label></td><td><input class="sand-box-input" id="desk-log-cl" name="desk_log_cl" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
											<td><label for="desk-log-aft">AFT:</label></td><td><input class="sand-box-input" id="desk-log-aft" name="desk_log_aft" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td></tr>
										</table>
									...
									<div id="front-sbox-content" style="display:none;">
										<table class="sand-box-table" cellspacing=0 border=0>											
											<tr>
												<td><label for="desk-log-front">Front Gross:</label>&nbsp;<input class="sand-box-input" id="desk-log-front" name="desk_log_front" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>									
											</tr>
											<tr id="desk-log-other-label">
												<td colspan=8><label>Other:</label></td>
											</tr>
											<tr id="desk-log-front-other">												    						
												<td><label for="desk-log-holdback">Holdback:</label></td><td><input class="sand-box-input" id="desk-log-holdback" name="desk_log_holdback" type="text" onkeyup="updateOnePercent()" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>												
												<td><label for="desk-log-onepercent">2%:</label></td><td><input class="sand-box-input" id="desk-log-onepercent-visible" disabled="true" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
												...
												<td><label for="desk-log-total-other">Total Other:</label></td><td><input class="sand-box-input" id="desk-log-total-other" disabled="true" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
											</tr>
										</table>
										<input id="desk-log-onepercent" name="desk_log_onepercent" type="hidden" onfocus="onfocus(this)" onblur="onblur(this, 0) "value="0" /></br>
										<input id="desk-log-other-input" name="desk_log_other" type="hidden" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></br>																				
									</div>
									<div id="trade-sbox-content" style="display:none;">
										<table class="sand-box-table" cellspacing=0 border=0>
											<tr>
											<td>Trade 1:</td>
											<td><label for="desk-log-trade1-year">Year:</label></td><td><input class="sand-box-input" id="desk-log-trade1-year" name="desk_log_trade1_year" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="" /></td>
											<td><label for="desk-log-trade1-make">Make:</label></td><td><input class="sand-box-input" id="desk-log-trade1-make" name="desk_log_trade1_make" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value="" /></td>	    						
											<td><label for="desk-log-trade1-model">Model:</label></td><td><input class="sand-box-input" id="desk-log-trade1-model" name="desk_log_trade1_model" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value=""></td>
											<td><label for="desk-log-trade1-miliage">Mileage:</label></td><td><input class="sand-box-input" id="desk-log-trade1-miliage" name="desk_log_trade1_miliage" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value=""></td>
											<td><label for="desk-log-trade1-acv">ACV:</label></td><td><input class="sand-box-input" id="desk-log-trade1-acv" name="desk_log_trade1_acv" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
											<td><label for="desk-log-trade1-deal-no">Deal #:</label></td><td><input class="sand-box-input" id="desk-log-trade1-deal-no" name="desk_log_trade1_deal_no" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this)" value="" /></td>
											<tr>
											<td>Trade 2:</td>
											<td><label for="desk-log-trade2-year">Year:</label></td><td><input class="sand-box-input" id="desk-log-trade2-year" name="desk_log_trade2_year" type="text" onfocus="onfocus(this)" onblur="onblur(this, 0)" onkeypress="onkeypress(event)" value="" /></td>
											<td><label for="desk-log-trade2-make">Make:</label></td><td><input class="sand-box-input" id="desk-log-trade2-make" name="desk_log_trade2_make" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this, null)" onblur="onblur(this)" value="" /></td>	    						
											<td><label for="desk-log-trade2-model">Model:</label></td><td><input class="sand-box-input" id="desk-log-trade2-model" name="desk_log_trade2_model" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value=""></td>											
											<td><label for="desk-log-trade2-miliage">Mileage:</label></td><td><input class="sand-box-input" id="desk-log-trade2-miliage" name="desk_log_trade2_miliage" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value=""></td>
											<td><label for="desk-log-trade2-acv">ACV:</label></td><td><input class="sand-box-input" id="desk-log-trade2-acv" name="desk_log_trade2_acv" type="text" onfocus="onfocus(this)" onblur="onblur(this, 0)" onkeypress="onkeypress(event)" value="0" /></td>
											<td><label for="desk-log-trade2-deal-no">Deal #:</label></td><td><input class="sand-box-input" id="desk-log-trade2-deal-no" name="desk_log_trade2_deal_no" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this)" value="" /></td>
											<tr>
											<td>Trade 3:</td>
											<td><label for="desk-log-trade3-year">Year:</label></td><td><input class="sand-box-input" id="desk-log-trade3-year" name="desk_log_trade3_year" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="" /></td>
											<td><label for="desk-log-trade3-make">Make:</label></td><td><input class="sand-box-input" id="desk-log-trade3-make" name="desk_log_trade3_make" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value="" /></td>	    						
											<td><label for="desk-log-trade3-model">Model:</label></td><td><input class="sand-box-input" id="desk-log-trade3-model" name="desk_log_trade3_model" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value=""></td>											
											<td><label for="desk-log-trade3-miliage">Mileage:</label></td><td><input class="sand-box-input" id="desk-log-trade3-miliage" name="desk_log_trade3_miliage" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, null)" value=""></td>
											<td><label for="desk-log-trade3-acv">ACV:</label></td><td><input class="sand-box-input" id="desk-log-trade3-acv" name="desk_log_trade3_acv" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="0" /></td>
											<td><label for="desk-log-trade3-deal-no">Deal #:</label></td><td><input class="sand-box-input" id="desk-log-trade3-deal-no" name="desk_log_trade3_deal_no" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this)" value="" /></td>
											</tr>
										</table>										
										<input id="desk-log-trade1-input" name="desk_log_trade1" type="hidden" value="0" />
										<input id="desk-log-trade2-input" name="desk_log_trade2" type="hidden" value="0" />
										<input id="desk-log-trade3-input" name="desk_log_trade3" type="hidden" value="0" />
									</div>
									...
									<div id="used-vehicle-sbox-content" style="display:none;">
										<table class="sand-box-table" cellspacing=0 border=0>
											<tr>
												...
												<td><label for="desk-log-veh-miliage">Mileage:</label></td><td><input class="sand-box-input" id="desk-log-veh-miliage" name="desk_log_miliage" onkeypress="onkeypress(event)" value="" /></td>
												...
												<td><label id="desk-log-veh-certified-no-label" for="desk-log-veh-certified-no" style="display:none;">Contract #:</label></td><td><input class="sand-box-input" id="desk-log-veh-certified-no" style="display:none;" name="desk_log_certified_no" onkeypress="onkeypress(event)" value="" /></td>											
											</tr>
											<tr>
												<td><label for="desk-log-veh-age">Age:</label></td><td><input class="sand-box-input" id="desk-log-veh-age" name="desk_log_age" onkeypress="onkeypress(event)" value="" /></td><td colspan=10></td>
											</tr>																		
										</table>																												
									</div>
					...
					$selectionBar = 
						'<form method=post id="desklog-options-form'.$this->appId.'" action="/gbSuite/home.php?app=sales_log">
					...
					$html .= "<tr>";
						...
						while($row = mysql_fetch_array($resuts))
						{
							...
							if($this->printing == false)
							{
								...
								$html .= "<td class='desk-log-cell'><a href='".$link."&uid".$this->user->getUID()."&action=edit&id=".$row['id']."'><img src='/images/resources/edit.gif' /></a></td>";
		...
		public function delete($params)
		{
			...
			$powerRankSetup['total_percentage'] = ($powerRankSetup['total_percentage'] > 0 ? $powerRankSetup['total_percentage'] / 100 : 0);
				...
				if($params['confirm'] == 'true')
				{
					...
					$html .= '<div><a class="button-link" href="/gbSuite/apps/process_application.php?app=sales_log&uid='.$this->user->getUID().'&action=delete&id='.$params['id'].'&redirect=sales_log" >Yes</a>&nbsp;<a class="button-link" href="/gbSuite/home.php?app=sales_log">Go back</a></div>';
				}
		...
		public function edit($params)
		{
			...
			$sql = "select id, deal_no, stock_no, customer, sp1, sp2, sm, fi, mod_no, last7vin, front, reserve, vsi, cc, gap, cl, 
							...
							trade1, trade1_acv, trade1_make, trade1_model, trade1_year, trade1_miliage, trade1_deal_no,  
							trade2, trade2_acv, trade2_make, trade2_model, trade2_year, trade2_miliage, trade2_deal_no, 
							trade3, trade3_acv, trade3_make, trade3_model, trade3_year, trade3_miliage, trade3_deal_no, 
			...
			///gbSuite/apps/process_application.php?app=sales_log&redirect=sales_log&action=save&uid=<?= $this->user->getUID()			
			?>
			<script>
			...
			<form method=post action='/gbSuite/apps/process_application.php?<? echo $processLink."&redirect=".($params['redirect'] != "" ? $params['redirect'] : "sales_log")."&action=save&uid=".$this->user->getUID(); ?>' id='desk-log'>
			<table width=100% border=0 cellmargin=0 cellpadding=0 cellspacing=0 class='desk-log-table'>
				...
				<?
					...
					//echo "<input class='button-link' type='button' value='Go back' onclick=document.setLocation('/gbSuite/home.php?app=sales_log') />";
											...
											if($field == 'notes')
											{
												...
												if($field != 'id')
												{
													if($field != 'total')
													{
														...
														{
															echo "<td class='desk-log-cell'><input class='desk-log-input' type=input id ='desk_log_". $field."' name='desk_log_". $field."' value='".$row[$field]."'/>" .
																	"<input type='hidden' id='name_".$field."' value='".$row[$field]."'>" .
																	"</td>";															
														}														
														else	
															if($field == 'back')
							...
							<div class="sbox-content-iframe" id="sbox-content">
								...
								<div id="front-sbox-content" style="display:none;">
									<table class="sand-box-table" cellspacing=0 border=0>
										...
										<tr id="desk-log-front-other">											    						
											...
											<td><label for="desk-log-onepercent">2%:</label></td><td><input class="sand-box-input" id="desk-log-onepercent-visible" disabled="true" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="'.$row['onepercent'].'" /></td>
								...
								<div id="trade-sbox-content" style="display:none;">
									<table class="sand-box-table" cellspacing=0 border=0>
										...
										<td><label for="desk-log-trade1-acv">ACV:</label></td><td><input id="desk-log-trade1-acv" name="desk_log_trade1_acv" class="sand-box-input" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="'.$row['trade1_acv'].'" /></td>
										<td><label for="desk-log-trade1-deal-no">Deal #:</label></td><td><input id="desk-log-trade1-deal-no" name="desk_log_trade1_deal_no" class="sand-box-input" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this)" value="'.$row['trade1_deal_no'].'" /></td></tr>
										<tr>
										...
										<td><label for="desk-log-trade2-acv">ACV:</label></td><td><input id="desk-log-trade2-acv" name="desk_log_trade2_acv" class="sand-box-input" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this, 0)" value="'.$row['trade2_acv'].'" /></td>
										<td><label for="desk-log-trade2-deal-no">Deal #:</label></td><td><input id="desk-log-trade2-deal-no" name="desk_log_trade2_deal_no" class="sand-box-input" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this)" value="'.$row['trade2_deal_no'].'" /></td></tr>
										<tr>
										...
										<td><label for="desk-log-trade3-deal-no">Deal #:</label></td><td><input id="desk-log-trade3-deal-no" name="desk_log_trade3_deal_no" class="sand-box-input" type="text" onkeypress="onkeypress(event)" onfocus="onfocus(this)" onblur="onblur(this)" value="'.$row['trade3_deal_no'].'" /></td></tr>
										</tr>
								...
								<div id="used-vehicle-sbox-content" style="display:none;">
									<table class="sand-box-table" cellspacing=0 border=0>
										<tr>
											...
											<td> 
													<select id="desk-log-veh-certified" name="desk_log_certified" class="desk-log-models" onchange="changeCertifiedOption()">
														<option value="Yes" '.($row['certified'] == 'Yes' ? 'selected=Yes' : '').'>Yes</option>
														<option value="No" '.($row['certified'] == 'No' ? 'selected=Yes' : '').'>No</option>
													</select>
											</td>
											<td><label id="desk-log-veh-certified-no-label" for="desk-log-veh-certified-no" style="display:'.($row['certified'] == 'Yes' ? 'block' : 'none').'">Contract #:</label></td><td><input class="sand-box-input" id="desk-log-veh-certified-no" style="display:'.($row['certified'] == 'Yes' ? 'block' : 'none').'" name="desk_log_certified_no" onkeypress="onkeypress(event)" value="'.$row['certified_no'].'" /></td>
										</tr>																	
										<tr>
		...
		public function add($params)
		{
			...
			$year1 = $params['desk_log_'.'trade1_year'];
			$year2 = $params['desk_log_'.'trade2_year'];
			$year3 = $params['desk_log_'.'trade3_year'];

			$make1 = $params['desk_log_'.'trade1_make'];
			$make2 = $params['desk_log_'.'trade2_make'];
			$make3 = $params['desk_log_'.'trade3_make'];
			
			$model1 = $params['desk_log_'.'trade1_model'];
			$model2 = $params['desk_log_'.'trade2_model'];
			$model3 = $params['desk_log_'.'trade3_model'];
			
			$miliage1 = $params['desk_log_'.'trade1_miliage'];
			$miliage2 = $params['desk_log_'.'trade2_miliage'];
			$miliage3 = $params['desk_log_'.'trade3_miliage'];
			
			$acv1 = $params['desk_log_'.'trade1_acv'];
			$acv2 = $params['desk_log_'.'trade2_acv'];
			$acv3 = $params['desk_log_'.'trade3_acv'];

			$acv1 = ($acv1 != "" ? $acv1 : 0) + 4000;
			$acv2 = ($acv2 != "" ? $acv2 : 0) + 4000;
			$acv3 = ($acv3 != "" ? $acv3 : 0) + 4000;
	
			if($sp2 == "0")
			{
				$name1 = "<fb:name uid=$uid1 />";
				...
				if($miliage1 != "")
					$value .= " with $miliage1 miles...";
				
				$value = "$name1 just took in a ".$value." approximate retail is $$acv1.";
				
				$query = "INSERT INTO news (id, uid, type, value, date, status) " .
						"SELECT 0, uid, 'trade', '$value', now(), 0 " .
						"FROM info ";
				...
				if($miliage2 != "")
					$value .= " with $miliage2 miles...";
				
				$value = "$name1 just took in a ".$value." approximate retail is $$acv2.";
				...
				if($miliage3 != "")
					$value .= " with $miliage3 miles...";
				
				$value = "$name1 just took in a ".$value." approximate retail is $$acv3.";
			...
			else
			{
				...
				$value = "$name1 and $name2 just took in a ".$value." approximate retail is $$acv1.";
				...
				$value = "$name1 and $name2 just took in a ".$value." approximate retail is $$acv2.";
				...
				$value = "$name1 and $name2 just took in a ".$value." approximate retail is $$acv3.";
