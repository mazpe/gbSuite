<?php
    ...
    class AssociatePowerRank extends Application
	{
		var $printing = false;
		private $option = null;
		private $sort = null;
		...
		{			
			...
			echo "<div class='report-title'>Associate Power Rank<br/>$dateRange</div>";
			//echo "<div class='report-subtitle'>September 2008</div>";
			
			$selectionBar = 
				'<form method=post id="desklog-options-form'.$this->appId.'" action="/gbSuite/home.php?app=pwr_associate">
			...
			if(!$this->printing)
			{
				...
				$link = "/gbSuite/apps/process_application.php?app=pwr_associate&action=print_report&uid=".$this->user->getUID();
			...
			AssociatePowerRank::updatePowerRank($tableName,$this->connection); 
			...
			$link = "/gbSuite/home.php?app=pwr_associate&order=".$newOrder;
			...
			<table align=center cellspacing=0 cellmargin=0 class='power-rank-table' width=95%>
				<tr>
					...
					<th class='power-rank-header'><a href="<? echo $link."&sort=pwr_associate"; ?>">PowerRank</a></th>
